...
#import tensorflow.keras.initializers.Initializer
import tensorflow.keras.initializers


class ConvolutionAware(tensorflow.keras.initializers.Initializer):
    """
    ...
    def __call__(self, shape):
        ...
        fan_in, fan_out = tensorflow.keras.initializers._compute_fans(shape, K.image_data_format())
        variance = 2 / fan_in
