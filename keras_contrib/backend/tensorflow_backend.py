...
from tensorflow.keras.backend import dtype
...
def clip(x, min_value, max_value):
    ...
    if min_value is None:
        min_value = -np.inf
    min_value = convert_to_tensor(min_value, x.dtype.base_dtype)
    max_value = convert_to_tensor(max_value, x.dtype.base_dtype)
