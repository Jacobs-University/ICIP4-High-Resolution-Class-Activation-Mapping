...
parser.add_argument('--target_name', type=str,
                    default="target",
                    help='name of the directory storing the results')

parser.add_argument('--data_dir', type=str,
                    default=os.path.join(os.getcwd(), "data", "resized"), 
                    help='directory where training data is located')

parser.add_argument('--weight_dir', type=str, #default="try/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5",
                    default="",#'results/densenet_fcn/animals/best_weights.h5',
                    help='path to a valid weight file')
parser.add_argument('--half_weight_dir', type=str, #default="try/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5",
                    default="",#'results/half_densenet_fcn/animals/best_weights.h5',
                    help='path to a valid weight file')
